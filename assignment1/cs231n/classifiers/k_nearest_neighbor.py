...
class KNearestNeighbor:
  ...
  def predict_labels(self, dists, k=1):
    ...
    for i in xrange(num_test):
      ...
      #########################################################################
      sorted_indx = np.argsort(dists[i,:])
      # sorted_indx[0] - smallest index loss
      closest_y = self.y_train[sorted_indx[:k]] # takes k-smallest index loss
      #########################################################################
      # TODO:                                                                 #
      ...
      nearest_dict = {}
      for c in closest_y:
          nearest_dict[c] = nearest_dict.get(c, 0) + 1

      y_pred[i] =  max(nearest_dict, key=nearest_dict.get)
      #########################################################################
      #                           END OF YOUR CODE                            # 
      #########################################################################
